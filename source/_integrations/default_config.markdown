...
Alternatively, you can list desired Integrations manually. This allows you to prevent the Home Assistant from loading integrations you wish to ommit.

```yaml
# Example configuration.yaml entry without default_config
automation:
assist_pipeline:
backup:
bluetooth:
